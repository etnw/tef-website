...
title: "The gap between <em>funded</em> and <em>revenue</em>."
layout: "items"
order: 8
items:
  ...
  - heading: "Time-to-Value"
    body: "Extends effective runway by up to 40%. We bypass the 6-month hire and 6-month ramp lag, deliver customer engagement in Week 1, and compress the time to \"Series B readiness.\""
  - heading: "Portfolio Scale"
    body: "Replicable across a fund, not just one company. Same methodology, reporting format, and pricing discipline at every engagement. Commercial performance becomes comparable between portfolio companies, and what works at one transfers to the next."
---
